...
and for tunning the achieved visual mapping status, such as by resizing
and moving nodes.
...
network size, open supervertices, levels exposed, and topological features such as commnity structures.
