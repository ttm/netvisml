...
{\bf \emph{BiNetVis}} algorithm for multilevel visualization of bipartite networks.
...
\begin{figure}\centering
 \includegraphics[width=\textwidth]{initial_}
  ...
  In the gray box, the user chooses the coarsening algorithm and sets its parameters (Appendix A details the parameters of coarsening algorithms). % Appendix~\ref{ap}.
...
%As in this example, in general, the multilevel strategy provides good insight about the original topology.


\begin{figure}[!h]\centering
    \subfloat[original]{{\includegraphics[width=.46\textwidth, height=4.3cm]{aor} }}%
    \qquad
  \subfloat[coarsened]{{\includegraphics[width=.46\textwidth, height=4.3cm]{01} }}%
...
%As exemplified, given the importance of the connectivity patterns, such as group structure, the method may assist research related to gene/protein networks.
...
\begin{figure}[!h]\centering
    \subfloat[level 2]{{\includegraphics[width=.33\textwidth, height=3.5cm]{02} }}%
  \subfloat[level 1]{{\includegraphics[width=.33\textwidth, height=3.5cm]{03} }}%
  \subfloat[level 0]{{\includegraphics[width=.33\textwidth, height=3.5cm]{04} }}%
